    ...
    <li>
        ...
        <ul>
            <li {!! (Request::is( 'form_elements') || Request::is( 'realtime_form') || Request::is( 'form_validations') || Request::is( 'form_layouts') || Request::is( 'complex_forms')|| Request::is( 'complex_forms2') || Request::is( 'radio_checkboxes') || Request::is( 'form_editors') || Request::is( 'form_wizards') || Request::is( 'dropdowns') || Request::is( 'datepicker') ||Request::is( 'advanceddate_pickers') ||Request::is( 'x-editable') ? 'class="menu-dropdown active"': 'class="menu-dropdown"') !!}>
                ...
                <ul class="sub-menu">
                    <li {!! (Request::is( 'form_elements') || Request::is( 'realtime_form') || Request::is( 'form_validations') || Request::is( 'form_layouts') || Request::is( 'complex_forms')|| Request::is( 'complex_forms2') || Request::is( 'radio_checkboxes') ? 'class="active"': 'class="menu-dropdown"') !!}>
                        <a href="javascript:void(0)">
                    ...
                    <li {!! (Request::is( 'form_editors') || Request::is( 'form_wizards') || Request::is( 'dropdowns') || Request::is( 'datepicker') || Request::is( 'advanceddate_pickers') ||Request::is( 'x-editable')? 'class="active"': 'class="menu-dropdown"') !!}>
                        <a href="javascript:void(0)">
                ...
                <ul class="sub-menu">
                    <li {!! (Request::is( 'calendar')? 'class="active"': "") !!}>
                        <a href="{{url('calendar')}}">
                            ...
                            <span class="mm-text">Calendar</span>
                            <small class="badge badge-success float-right">7</small>
                        </a>
                    </li>
                    <li {!! (Request::is( 'calendar2')? 'class="active"': "") !!}>
                        <a href="{{url('calendar2')}}">
                            ...
                            <small class="badge badge-success float-right">6</small>
                        </a>
                    </li>
                </ul>
            </li>
            <li {!! (Request::is( 'masonry_gallery')  || Request::is( 'dropify') || Request::is( 'image_hover') || Request::is( 'image_filter') || Request::is( 'image_magnifier') ? 'class="active menu-dropdown"': 'class="menu-dropdown"') !!}>
                <a href="javascript:void(0)">
