    ...
    <section class="content">
                ...
                <div class="panel ">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="ti-layout-grid3"></i> Apartment Types
                        </h3>

                    </div>
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="typesTbl">
                                <thead>
                                    <tr>
                                        <th>
                                            Name
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">New Apartment Type</h4>
                    </div>
                    <form role="form" id="saveApartmentTypeForm">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row form-group ">
                                <div class="col-sm-3 float-sm-right">
                                    <label  class="form-control-label">Apartment Type Name</label>
                                </div>
                                <div class="col-sm-9">
        ...
        <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form method="post" id="deleteApartment TypeForm">
                        <div class="modal-body">
                            <div>
                                <p>
...
<script src="{{ asset('js/apartmenttypes.js')}}" type="text/javascript"></script>
